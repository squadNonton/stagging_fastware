                    ...
                    <div class="card">
                        <div class="accordion">
                            <div class="card-body">
                                ...
                                <div class="collapse" id="updateProgress">
                                    <form id="importForm" method="POST" action="{{ route('spareparts.import', ['nomor_mesin' => $mesin->no_mesin]) }}" enctype="multipart/form-data" onsubmit="return validateForm()">
                                        @csrf
                                        <input type="file" id="file" name="file" class="form-control">
                                        <br>
                                        <button class="btn btn-danger">Unggah Sparepart</button>
                                    </form>
