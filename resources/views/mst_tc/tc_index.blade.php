                ...
                <tbody>
                    @foreach ($technicalData as $index => $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('mst_tc.edit', $data->id) }}" class="btn btn-warning"> <i
                ...
                <tbody>
                    @foreach ($softSkillsData as $index => $data)
                        <tr>
                            ...
                            <td>{{ $data->jobPosition->job_position }}</td>
                            <td>
                                <a href="{{ route('mst_sk.editSoftSKills', $data->id) }}" class="btn btn-warning"> <i
                                        class="fas fa-edit"></i> Edit</a>
                            </td>
                        </tr>
                    @endforeach
                ...
                <tbody>
                    @foreach ($additionalData as $index => $data)
                        <tr>
                            ...
                            <td>{{ $data->jobPosition->job_position }}</td>
                            <td>
                                <a href="{{ route('mst_ad.editAdditionals', $data->id) }}" class="btn btn-warning"> <i
                                        class="fas fa-edit"></i> Edit</a>
                            </td>
                        </tr>
                    @endforeach
