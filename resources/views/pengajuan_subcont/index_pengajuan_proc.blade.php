                                        ...
                                        @foreach ($pengajuanSubconts as $key => $pengajuan)
                                            @if (in_array($pengajuan->status_1, [2, 3, 4, 5]))
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @if ($pengajuan->status_1 >= 3 && $pengajuan->status_1 <= 5)
                                                            @if ($diff_days <= 3 || ($diff_days > 3 && $has_quotation_file))
                                                                <span style="color: green; font-size: 24px;">●</span> <!-- Bulat hijau -->
                                                            @endif
                                                        @endif
                                
                                                        @if ($diff_days > 3 && !$has_quotation_file)
                                                            <span style="color: red; font-size: 24px;">●</span> <!-- Bulat merah -->
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('pengajuan-subcont.editProc', $pengajuan->id) }}" class="btn btn-sm btn-success">
                                                            <i class="fas fa-edit"></i> Pengajuan Subcont
                                                        </a>
                                                    </td>
                                                </tr>
                                            @endif
